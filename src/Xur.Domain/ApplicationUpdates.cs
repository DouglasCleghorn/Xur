...
public record ApplicationUpdateStatus(string Server,ApplicationVersion Current,ApplicationVersion? Previous,ApplicationVersion? Available,ApplicationUpdateOperation? Operation,bool Busy,bool Development=false,string Channel="stable",string? PublicKey=null,string? LocalServer=null);
public record ApplicationUpdateRequest(string Action,string? Server=null,bool Development=false,string Channel="stable",string? PublicKey=null);
